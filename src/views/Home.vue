<template>
  <div class="container mt-3">
    ...
    <div class="flow-chart">
      ...
      <!-- Activities Card -->
      <div class="flow-step">
        <BCard img-src="https://images.unsplash.com/photo-1585757318177-0570a997dc3a?w=300&h=150&fit=crop" :img-alt="$t('home.activitiesAlt')" img-top class="flow-card">
      ...
      <!-- Registrations Card -->
      <div class="flow-step">
        <BCard img-src="https://images.unsplash.com/vector-1741203969096-deda346274e8?w=300&h=150&fit=crop" :img-alt="$t('home.registrationsAlt')" img-top class="flow-card">
      ...
      <!-- Participants Card -->
      <div class="flow-step">
        <BCard img-src="https://images.unsplash.com/photo-1548705085-101177834f47?w=300&h=150&fit=crop" :img-alt="$t('home.participantsAlt')" img-top class="flow-card">
